            ...
            <tbody>
                @foreach($employees as $employee)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.employees.show', $employee->id) }}" class="btn btn-primary btn-sm">Show</a>
                            <a href="{{ route('admin.employees.edit', $employee->id) }}" class="btn btn-success btn-sm">Edit</a>
